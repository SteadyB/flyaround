...
class FlightController extends Controller
{
    ...
    public function showAction(Flight $flight, FlightInfo $flightInfo)
    {
        ...
        $distance = $flightInfo->getDistance(
            $flight->getDeparture()->getLatitude(), $flight->getDeparture()->getLongitude(),
            $flight->getArrival()->getLatitude(), $flight->getArrival()->getLongitude()
        );

        $cruiseSpeed = $flight->getPlane()->getCruiseSpeed();
        $flightTime = $flightInfo->getTime($distance, $cruiseSpeed);
